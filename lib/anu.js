...
module.exports = WAConnection = (_wea) => {
    class WAConnection extends _wea {
        ...
        sendButtons(jid, text, buttons, footer, mek ) {
            let btn = []
            buttons.forEach(x => {
            ...
            return this.sendMessage(jid, btnMsg, MessageType.buttonsMessage, { quoted : mek })
        }
...
sendButtons2 = (from, text, footer, button, text2) =>{
teswoi = {
contentText: text,
footerText: footer,
buttons: button,
...
return this.sendMessage(from, teswoi, MessageType.buttonsMessage,{contextInfo: { mentionedJid: text2}})
}
